...
(function ($) {
    ...
    app.counter = function () {
        ...
        let time = setInterval(function () {
            ...
            let timeDifferenceInMinutes = finalDate - starterDate;
            let days = Math.floor(timeDifferenceInMinutes / (1000 * 60 * 60 * 24));
            let hours = Math.floor(
                (timeDifferenceInMinutes % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
            );
            let minutes = Math.floor(
                (timeDifferenceInMinutes % (1000 * 60 * 60)) / (1000 * 60)
            );
            let seconds = Math.floor(
                (timeDifferenceInMinutes % (1000 * 60)) / 1000
            );
    ...
    app.displayName = function () {
        ...
        $("#name").html("The winner of tonight is : <br>" + listPlayers[indexPlayer]);
